...
import '../css/IndicadoresFinancieros.css'; // Asegúrate de importar el CSS
  ...
  return (
    <div className="estado-container">
      <div className="centrar">
        ...
        <h4>Análisis Vertical del Balance General</h4>
      ...
      {balanceData ? (
        <div>
          ...
          <ul>
            ...
            <li>Ajustes y Efectos por Valuación y Cambio de Valor: {formatearNumero(balanceData.ajustesEfectosValuacion)} ({calcularPorcentaje(balanceData.ajustesEfectosValuacion, balanceData.totalPatrimonio)})</li>
          </ul>
        ...
        <p>Por favor selecciona un año para ver el análisis vertical.</p>
      )}
    </div>
  );
}
